                ...
                <div class="contact__infos">
                    <div>
                        <div class="contact__infos__header">
                            <img src="{{asset('assets/images/phone-contact-icon.svg')}}" alt="">
                    ...
                    <div>
                        <div class="contact__infos__header">
                            <img src="{{asset('assets/images/mail-contact-icon.svg')}}" alt="">
                    ...
                    <div>
                        <div class="contact__infos__header">
                            <img src="{{asset('assets/images/pin-map-contact-icon.svg')}}" alt="">
